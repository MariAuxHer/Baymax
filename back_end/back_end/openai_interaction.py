...
# imported text classification model
...
# vocabulary for text classification model
...
# paramaters for text classification model
max_features = 10000
sequence_length = 250

# creates layer for converting text into format for prediction
...
# base for text classification model
...
def generate_llm_response(prompt, user_city):
    ...
    if conversations:
        ...
        # perform text classification to determine specialization
        else:
            ...
            # checks the confidence of the text classification model
            ...
            if max_val < 0.5:
                ...
                # adds line to response to tell user where they can get more information
